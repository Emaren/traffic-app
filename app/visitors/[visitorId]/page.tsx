      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-300">
                Current 24-hour visitor profile for this fingerprint. This is the first live cut of
                the autogenerated visitor view, so it is window-based until persistence lands.
              </p>
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <StatCard
            ...
            helper="Stable visitor profile key used for this first autogenerated profile page."
          />
        </section>
        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-[0.75fr_1.25fr]">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <p className="mt-2 text-sm text-slate-300">
              Newest session first. Expand a row to see the full page path and why Traffic thinks it
